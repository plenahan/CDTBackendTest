...
router.get('/new', (req, res) => {
    res.render('create/links/new', { link: new Link() })
})
...
router.get('/:id/edit', async (req, res) => {
    try {
        const link = await Link.findById(req.params.id)
        res.render('create/links/edit', { link: link })
    } catch {
        res.redirect('/links')
    }
})
